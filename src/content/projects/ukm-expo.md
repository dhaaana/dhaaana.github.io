---
title: ITS UKM Expo
href: http://ukmexpo-its.com
cover: ukm-expo/main-page.png
description: ukmexpo-its.com is a website that host yearly event for showcasing all student unit in ITS. Created using React framework Next.Js, Typescript and Tailwind
isFeatured: true
stack: cib:next-js, cib:typescript, file-icons:tailwind
---
