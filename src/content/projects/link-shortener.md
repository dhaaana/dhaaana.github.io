...
href: https://github.com/dhaaana/anjay
cover: link-shortener/main-page.png
description: This link shortener is my personal project made using Next.js, Typescript, Tailwind, and Prisma for the backend. The middleware feature in next js allowed this link shortener to redirect super-fast without stop by
stack: cib:next-js, cib:typescript, file-icons:tailwind, file-icons:prisma
---
